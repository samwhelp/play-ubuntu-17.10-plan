...
base_var_init () {
	...
	THE_XFCE4_CONF_MAIN_FILE_NAME="xfce4.conf"
	THE_XFCE4_CONF_MAIN_FILE_PATH="$THE_XFCE4_CONF_MAIN_DIR_PATH/$THE_XFCE4_CONF_MAIN_FILE_NAME" ## ~/.config/xfce4/xfce4.conf

	THE_XFCONF_CONF_SET_DIR_NAME="xfconf"
	THE_XFCONF_CONF_SET_DIR_PATH="$THE_XFCE4_CONF_SET_DIR_PATH/$THE_XFCONF_CONF_SET_DIR_NAME" ## /usr/share/play-xfce4/var/conf/xfce4.set/xfconf

	THE_XFCE_PERCHANNEL_CONF_SET_DIR_NAME="xfce-perchannel-xml"
	THE_XFCE_PERCHANNEL_CONF_SET_DIR_PATH="$THE_XFCONF_CONF_SET_DIR_PATH/$THE_XFCE_PERCHANNEL_CONF_SET_DIR_NAME" ## /usr/share/play-xfce4/var/conf/xfce4.set/xfconf/xfce-perchannel-xml

	THE_XFCONF_CONF_MAIN_DIR_NAME="xfconf"
	THE_XFCONF_CONF_MAIN_DIR_PATH="$THE_XFCE4_CONF_MAIN_DIR_PATH/$THE_XFCONF_CONF_MAIN_DIR_NAME" ## ~/.config/xfce4/xfconf

	THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_NAME="xfce-perchannel-xml"
	THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_PATH="$THE_XFCONF_CONF_MAIN_DIR_PATH/$THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_NAME" ## ~/.config/xfce4/xfconf/xfce-perchannel-xml



	THE_ROFI_CONF_SET_FILE_NAME="rofi.set.conf"
	THE_ROFI_CONF_SET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_ROFI_CONF_SET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/rofi.set.conf

	THE_ROFI_CONF_RESET_FILE_NAME="rofi.reset.conf"
	THE_ROFI_CONF_RESET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_ROFI_CONF_RESET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/rofi.reset.conf
	...
	THE_GTK2_CONF_SET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_GTK2_CONF_SET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/gtk2.set.conf

	THE_GTK2_CONF_RESET_FILE_NAME="gtk2.reset.conf"
	THE_GTK2_CONF_RESET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_GTK2_CONF_RESET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/gtk2.reset.conf
	...
	THE_GTK3_CONF_SET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_GTK3_CONF_SET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/gtk3.set.conf

	THE_GTK3_CONF_RESET_FILE_NAME="gtk3.reset.conf"
	THE_GTK3_CONF_RESET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_GTK3_CONF_RESET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/gtk3.reset.conf
	...
	THE_GTK3_CONF_MAIN_FILE_PATH="$THE_GTK3_CONF_MAIN_DIR_PATH/$THE_GTK3_CONF_MAIN_FILE_NAME" ## ~/.config/gtk-3.0/settings.ini


	THE_FCITX_CONF_SET_FILE_NAME="fcitx.set.conf"
	THE_FCITX_CONF_SET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_FCITX_CONF_SET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/fcitx.set.conf

	THE_FCITX_CONF_RESET_FILE_NAME="fcitx.reset.conf"
	THE_FCITX_CONF_RESET_FILE_PATH="$THE_CONF_DIR_PATH/$THE_FCITX_CONF_RESET_FILE_NAME" ## /usr/share/play-lxqt/var/conf/fcitx.reset.conf
...
base_var_dump () {
	...
	echo "THE_XFCONF_CONF_SET_DIR_NAME=$THE_XFCONF_CONF_SET_DIR_NAME"
	echo "THE_XFCONF_CONF_SET_DIR_PATH=$THE_XFCONF_CONF_SET_DIR_PATH"

	echo "THE_XFCE_PERCHANNEL_CONF_SET_DIR_NAME=$THE_XFCE_PERCHANNEL_CONF_SET_DIR_NAME"
	echo "THE_XFCE_PERCHANNEL_CONF_SET_DIR_PATH=$THE_XFCE_PERCHANNEL_CONF_SET_DIR_PATH"

	echo "THE_XFCONF_CONF_MAIN_DIR_NAME=$THE_XFCONF_CONF_MAIN_DIR_NAME"
	echo "THE_XFCONF_CONF_MAIN_DIR_PATH=$THE_XFCONF_CONF_MAIN_DIR_PATH"

	echo "THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_NAME=$THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_NAME"
	echo "THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_PATH=$THE_XFCE_PERCHANNEL_CONF_MAIN_DIR_PATH"
